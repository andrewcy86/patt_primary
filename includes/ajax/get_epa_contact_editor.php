...
$box_patt_id = $wpdb->get_row("SELECT box_id, lan_id, id FROM " . $wpdb->prefix . "wpsc_epa_folderdocinfo_files WHERE folderdocinfofile_id = '" . $folderfile_id . "'");
...
<input type="hidden" id="dbid" name="dbid" value="<?php echo $dbid; ?>"> 
</form>
<?php 
$body = ob_get_clean();
ob_start();
