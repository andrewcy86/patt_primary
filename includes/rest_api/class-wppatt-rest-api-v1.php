...
if ( ! class_exists( 'wppatt_Rest_API_v1' ) ) :
  
    final class wppatt_Rest_API_v1 {
        ...
        public static function api_register() {
            ...
            register_rest_route( 'supportcandy/v1', '/login', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'user_login' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_secret_key' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', '/guestTicketFormFields', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_ticket_form_fields' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_guest_user' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', '/ticketFormFields', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_ticket_form_fields' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_registered_user' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', '/agentonlyFields', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_agentonly_fields' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_agent' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', '/statuses', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_status_list' ),
      				'methods' => 'GET'
      			));
            
            register_rest_route( 'supportcandy/v1', '/statuses/(?P<id>\d+)', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_status' ),
      				'methods' => 'GET'
      			));
            
            register_rest_route( 'supportcandy/v1', '/categories', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_category_list' ),
      				'methods' => 'GET'
      			));
            
            register_rest_route( 'supportcandy/v1', '/categories/(?P<id>\d+)', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_category' ),
      				'methods' => 'GET'
      			));
            
            register_rest_route( 'supportcandy/v1', '/priorities', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_priority_list' ),
      				'methods' => 'GET'
      			));
            
            register_rest_route( 'supportcandy/v1', '/priorities/(?P<id>\d+)', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_priority' ),
      				'methods' => 'GET'
      			));
            
            register_rest_route( 'supportcandy/v1', '/filters', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_filters' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_registered_user' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', '/tickets', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_tickets' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_registered_user' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', '/tickets/(?P<id>\d+)', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_individual_ticket' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_ticket_read_permission' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', '/tickets/(?P<id>\d+)/threads', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_ticket_threads' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_ticket_read_permission' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', 'threads/historyId', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_thread_history_id' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_registered_user' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', 'threads/history', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_thread_history' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_registered_user' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', 'tickets/addRegisteredUserTicket', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'create_new_ticket' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_registered_user' ),
      				'methods' => 'POST'
      			));
            ...
            register_rest_route( 'supportcandy/v1', 'tickets/(?P<id>\d+)/addReply', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'submit_reply' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_ticket_reply_permission' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', 'tickets/(?P<id>\d+)/addNote', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'submit_note' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_ticket_note_permission' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', 'tickets/(?P<id>\d+)/updateFields', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'update_ticket_fields' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_agent' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', 'tickets/attachRegisteredUserFile', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'file_attachment' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_registered_user_attachment' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', 'tickets/attachGuestFile', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'file_attachment' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_guest_attachment' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', 'tickets/autocompleteSuggestions', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'autocomplete_suggestions' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_agent' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', '/agents', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_agents' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_agent' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', '/agents/(?P<id>\d+)', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'get_agent' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_agent' ),
      				'methods' => 'POST'
      			));
            
            register_rest_route( 'supportcandy/v1', '/deleteTickets/(?P<id>\d+)', array(
      				'callback' => array( 'wppatt_Rest_v1_Helper', 'delete_ticket_by_id' ),
              'permission_callback' => array( 'wppatt_Rest_v1_Helper', 'validate_agent' ),
      				'methods' => 'POST'
      			));
        ...
        public static function validate_auth_token(){
            ...
            $secret_key = get_option('wppatt_rest_api_secret_key');
