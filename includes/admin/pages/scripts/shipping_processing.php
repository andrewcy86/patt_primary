...
$shipped_html_yes = '<span style="font-size: 1.3em; color: #2F631D;"><i class="fas fa-check-circle" tabindex="0" aria-hidden="true" title="Shipped" aria-label="Shipped"></i><span class="sr-only">Shipped</span></span>';
$shipped_html_no = '<span style="font-size: 1.3em; color: #8b0000;"><i class="fas fa-times-circle" tabindex="0" aria-hidden="true" title="Not Shipped" aria-label="Not Shipped"></i><span class="sr-only">Not Shipped</span></span>';
$delivered_html_yes = '<span style="font-size: 1.3em; color: #2F631D;"><i class="fas fa-check-circle" tabindex="0" aria-hidden="true" title="Delivered" aria-label="Delivered"></i><span class="sr-only">Delivered</span></span>';
$delivered_html_no = '<span style="font-size: 1.3em; color: #8b0000;"><i class="fas fa-times-circle" tabindex="0" aria-hidden="true" title="Not Delivered" aria-label="Not Delivered"></i><span class="sr-only">Not Delivered</span></span>';
