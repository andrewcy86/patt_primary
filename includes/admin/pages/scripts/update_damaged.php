...
//Documents cannot be marked as Damaged in these statuses
if( ($get_box_status_val == $box_completed_dispositioned_tag->term_id) || in_array($get_ticket_status_val, $status_id_arr) ) {
   $ticket_box_status++; 
}
